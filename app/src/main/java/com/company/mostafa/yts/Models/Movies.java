...
public class Movies {
    ...
    public Movies(String movie_id, String title, String year, String rating, String runtime, String genres, String summary, String yt_trailer_code, String large_cover_image, String url_torrents, String quality, String size, String imdb_code, String large_screenshot_image1, String large_screenshot_image2, String large_screenshot_image3, String url_cast_image, String cast_name, String char_name) {
    ...
    public Movies(String movie_id, String title, String rating, String large_cover_image) {
        this.movie_id = movie_id;
        this.title = title;
        this.rating = rating;
        this.large_cover_image = large_cover_image;
